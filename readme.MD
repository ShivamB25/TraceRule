...
- Primary model: **Claude Sonnet 4.6** (`claude-sonnet-4-6`) with adaptive thinking. High effort for compilation, medium effort for explanations.
- The deterministic scan path does not call any model.
